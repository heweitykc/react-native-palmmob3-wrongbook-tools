            ...
            <View style={{ flex: 1 }} >
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    ...
                    <View style={[styles.con, { left: img_rect.x, top: img_rect.y, width: con_w, height: con_h }]} onTouchStart={this.onConvTouch}>
                        <Animated.View
                            style={[styles.inputv, { top: (con_h - inputv_h) / 2, left: (con_w - inputv_w) / 2, minWidth: inputv_w, minHeight: inputv_h }, {
                        ...
                        >
                            ...
                            <TouchableHighlight style={styles.inputv_close}>
                                <Image style={styles.inputv_close_img} source={require('../Resources/lib_close.png')} />
                            </TouchableHighlight>
                        </Animated.View>
                    </View>
                </View>
